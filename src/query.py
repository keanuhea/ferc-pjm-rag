"""Query the vector store: retrieve top-k chunks, generate an answer with citations."""

from __future__ import annotations

from dataclasses import dataclass

from src.config import TOP_K, configure_llama_index, get_chroma_collection
